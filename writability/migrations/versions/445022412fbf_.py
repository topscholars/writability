...
def upgrade():
    ...
    op.add_column('essay_associations', sa.Column('created_ts', SerializableDateTime, nullable=False, server_default=_utcnow))
    ...
    op.add_column('essay_associations', sa.Column('updated_ts', SerializableDateTime, nullable=False, server_default=_utcnow))

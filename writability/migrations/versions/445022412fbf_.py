...
def upgrade():
    ...
    op.add_column('essay_associations', sa.Column('created_ts', SerializableDateTime, nullable=False))
    op.add_column('essay_associations', sa.Column('deleted_ts', SerializableDateTime, nullable=True))
    op.add_column('essay_associations', sa.Column('state', sa.String(), nullable=False))
    op.add_column('essay_associations', sa.Column('updated_ts', SerializableDateTime, nullable=False))
